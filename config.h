...
/* appearance */
static const unsigned int borderpx  = 0;        /* border pixel of windows - must be 0 for rounded corners */
static const int CORNER_RADIUS = 10;            /* corner radius for rounded corners */
